...
![SDN-API-Topo](./docs/images/sdn-api-topo.png)

### My Topology

![Topology](./docs/images/my-topology.png)

### SDN initial request

![initialrequest](./docs/images/initial-request.png)

## SDN With matching flow record

![subrequest](./docs/images/matching-flow.png)
...
![subrequest](./docs/images/elastiflow-license.png)
...
### Create Bridge(_`setup-bridge.sh`_) & vSwitch(`setup-dc.sh`), then deploy the lab(`clab deploy`):
...
![subrequest](./docs/images/flowman-dash.png)
